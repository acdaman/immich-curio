...
from curio.db import get_queue_depth, get_unscored_asset_ids
...
async def _score_and_tag(asset_id: str) -> None:
    try:
...
async def queue_filler_loop() -> None:
